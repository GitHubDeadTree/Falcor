...
backup_file = 'media/test_scenes/Classroom_light/Classroom_light.gltf.volumetric_backup'
...
# 正则表达式，匹配 "name": "Light SourceFor volumetric" 模式的字符串
# 使用转义来处理空格和特殊字符
pattern = re.compile(r'"name"\s*:\s*"(Light SourceFor volumetric[^"]*)"')
